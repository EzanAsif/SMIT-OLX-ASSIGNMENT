                    ...
                    <div className="footer-links">
                        <div className="ind-link">
                            ...
                            <ul>
                                ...
                                <a href="#home"><li>Flats for rent</li></a>
                                <a href="#home"><li>Jobs</li></a>
                        ...
                        <div className="ind-link">
                            ...
                            <div className="links-links">
                                <ul>
                                    <a href="#home"><li>Bikes</li></a>
                                    <a href="#home"><li>Watches</li></a>
                                    <a href="#home"><li>Books</li></a>
                                    <a href="#home"><li>Dogs</li></a>
                                </ul>
                            </div>
                        </div>
                        <div className="ind-link">
                            ...
                            <div className="links-links">
                                <ul>
                                    <a href="#home"><li>About OLX Group</li></a>
                                    <a href="#home"><li>OLX Blog</li></a>
                                    <a href="#home"><li>OLX For Business Us</li></a>
                                </ul>
                            </div>
                        </div>
                        <div className="ind-link">
                            ...
                            <div className="links-links">
                                <ul>
                                    <a href="#home"><li>Help</li></a>
                                    <a href="#home"><li>Sitemap</li></a>
                                    <a href="#home"><li>Legal And Privacy Information</li></a>
                                </ul>
                            </div>
                        </div>
                    </div>
